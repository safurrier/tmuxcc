...
impl HelpWidget {
    pub fn render(frame: &mut Frame, area: Rect, scroll: u16) {
        ...
        let help_text = vec![
            ...
            blank(),
            key("  Tab          ", "Cycle focus: Sidebar -> Preview -> Input", key_style, desc_style),
            key("  Shift+Tab    ", "Cycle focus backwards", key_style, desc_style),
            ...
            context("  Active when the left panel has a cyan border.", context_style),
            blank(),
            ...
            key("  [            ", "Collapse all sessions", key_style, desc_style),
            key("  ]            ", "Expand all sessions", key_style, desc_style),
            blank(),
            Line::from(vec![Span::styled("  Agent actions", desc_style)]),
            key("  y / Y        ", "Approve pending request(s)", key_style, desc_style),
            key("  N            ", "Reject pending request(s)", key_style, desc_style),
            key("  a / A        ", "Approve ALL pending requests", key_style, desc_style),
            key("  1-9          ", "Send numbered choice to agent", key_style, desc_style),
            blank(),
            Line::from(vec![Span::styled("  Pane management", desc_style)]),
            key("  f / F        ", "Focus pane in tmux (switches session too)", key_style, desc_style),
            key("  dd           ", "Kill pane (double-tap d for safety)", key_style, desc_style),
            key("  R            ", "Rename pane's tmux window", key_style, desc_style),
            blank(),
            Line::from(vec![Span::styled("  Spawn agent", desc_style)]),
            key("  n            ", "Enter spawn mode for the current session", key_style, desc_style),
            Line::from(vec![
                Span::styled("                 ", dim_style),
                Span::styled("Then: c=Claude  C=Claude(safe)  x=Codex  g=Gemini  o=OpenCode  Esc=cancel", dim_style),
            ]),
            blank(),
            Line::from(vec![Span::styled("  Multi-select", desc_style)]),
            key("  Space        ", "Toggle selection on current agent", key_style, desc_style),
            key("  Ctrl+a       ", "Select all agents", key_style, desc_style),
            ...
            context("  Active when the right panel has a cyan border. Tab to get here.", context_style),
            blank(),
            ...
            context("  Active when the bottom input box has a cyan border. Tab twice to get here.", context_style),
            blank(),
            key("  Enter        ", "Send typed text to selected agent", key_style, desc_style),
            key("  Shift+Enter  ", "Insert newline (multi-line input)", key_style, desc_style),
            key("  Esc          ", "Back to sidebar", key_style, desc_style),
            blank(),
            blank(),
