...
if wait_for_text "smoke-session:tmuxcc" "m:muted" 5; then
    pass "Pressing 'm' mutes notifications (footer shows 'm:muted')"
else
    fail "Footer does not show 'm:muted' after pressing 'm'"
fi
